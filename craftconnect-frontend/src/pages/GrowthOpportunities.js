      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-10 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-text-secondary max-w-2xl mx-auto leading-relaxed">
            We've identified key areas where KarigarConnect can help you shine
            brighter and expand your craft's reach.
          </p>
        </div>
        ...
        <div className="space-y-16">
          {opportunities.map((opportunity, index) => (
            <div
              ...
              className={`${
                opportunity.color
              } rounded-2xl p-8 sm:p-12 flex flex-col lg:flex-row items-center gap-8 ${
